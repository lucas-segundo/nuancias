      ...
      >
        ...
        <div>
          ...
          <p>
            ...
            <a href="https://www.instagram.com/lucassegundof/">Lucas Segundo</a>
            , fundador do Nuancias. Estou aqui para falar pessoalmente do que se
            trata esse site.
          </p>
          <p>
            O <strong>Nuancias</strong> é uma{' '}
            <strong>plataforma de publicação</strong> visando trazer histórias
            que possam, de alguma forma, trazer aprendizados e pontos de vistas
            diferentes, assim como acontece quando estamos com os amigos, onde
            cada um tem uma história para compartilhar de algo que ocorreu na
            vida.
          </p>
          <p>
            <strong>É importante</strong> que saiba que cada categoria de
            história (moda, programação, saúde e entre outros) é chamada de{' '}
            <strong>Nuancia</strong>. Ou seja, quer saber das nuancias de saúde?
            Acesse as histórias marcada com esse tipo. Simples assim.
          </p>
