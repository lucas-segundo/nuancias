...
import { Button, Meta } from 'presentation/components/elements'
        ...
        <section className="w-full mt-40 max-w-3xl mx-auto flex flex-col justify-center border rounded shadow">
          <div className="text-center p-4">
            ...
            <p className="text-gray-600 my-4">
              Ocorreu um erro interno no servidor ao tentar realizar o que
              deseja. Por favor, tente novamente mais tarde.
            </p>
