...
export type GetPostsByFilterQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']>
  sortBy?: InputMaybe<
...
export type GetPostsByTextQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']>
  sortBy?: InputMaybe<
    Array<InputMaybe<Scalars['String']>> | InputMaybe<Scalars['String']>
  >
  searchTo?: InputMaybe<Scalars['String']>
}>
  ...
  posts?: {
    data: Array<{
      ...
      attributes?: {
        ...
        slug: string
        user?: {
          data?: { attributes?: { username: string } | null } | null
        } | null
      } | null
    }>
  } | null
...
export type GetPostsSlugAndUsernameQueryVariables = Exact<{
  limit: Scalars['Int']
}>
